...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Pavel Han', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '尝试从底层原理的角度去理解和解释技术问题', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://pavelhan.tech', // 网站地址
